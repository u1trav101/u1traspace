...
CREATE USER IF NOT EXISTS 'u1traspace'@'localhost' IDENTIFIED WITH mysql_native_password AS '*42FCEC4876A794A22B58238AEFC8E182E1899739';
CREATE USER IF NOT EXISTS 'u1traspace'@'127.0.0.1' IDENTIFIED WITH mysql_native_password AS '*42FCEC4876A794A22B58238AEFC8E182E1899739';
CREATE USER IF NOT EXISTS 'u1traspace'@'%' IDENTIFIED WITH mysql_native_password AS '*42FCEC4876A794A22B58238AEFC8E182E1899739';

GRANT INSERT, SELECT, DELETE, UPDATE, EXECUTE ON u1traspace.* TO 'u1traspace'@'localhost';
GRANT INSERT, SELECT, DELETE, UPDATE, EXECUTE ON u1traspace.* TO 'u1traspace'@'127.0.0.1';
GRANT INSERT, SELECT, DELETE, UPDATE, EXECUTE ON u1traspace.* TO 'u1traspace'@'%';
